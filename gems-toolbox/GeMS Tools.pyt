...
class DocxToDMU(object):
    ...
    def execute(self, parameters, messages): 
        ...
        # the script tool has been imported as a module. Now call the main function
        GeMS_DocxToDMU_AGP2.main(parameter_values)

class CompactAndBackup(object):
    """"\Scripts\GeMS_CompactAndBackup_AGP2.py"""
    def __init__(self):
    ...
    def execute(self, parameters, messages):
        ...
        # the script tool has been imported as a module. Now call the main function
        GeMS_CompactAndBackup_AGP2.main(parameter_values)

class Deplanarize(object):
    """Scripts\GeMS_Deplanarize_AGP2.py"""
    def __init__(self):
    ...
    def execute(self, parameters, messages):
        ...
        # the script tool has been imported as a module. Now call the main function
        GeMS_Deplanarize_AGP2.main(parameter_values)

class MakePolys(object):
    """\Scripts\GeMS_MakePolys_AGP2.py"""
    def __init__(self):
    ...
    def execute(self, parameters, messages):
        ...
        # the script tool has been imported as a module. Now call the main function
        GeMS_MakePolys3_AGP2.main(parameter_values) 

class MakeTopology(object):
    """\Scripts\GeMS_MakeTopology_AGP2.py"""
    def __init__(self):
    ...
    def execute(self, parameters, messages):
        ...
        # the script tool has been imported as a module. Now call the main function
        GeMS_MakeTopology_AGP2.main(parameter_values) 

class MapOutline(object):
    """\Scripts\mapOutline_AGP2.py"""
    def __init__(self):
    ...
    def execute(self, parameters, messages):
        ...
        # the script tool has been imported as a module. Now call the main function
        mapOutline_AGP2.main(parameter_values) 

class ProjectCrossSectionData(object):
    """\Scripts\GeMS_ProjectCrossSectionData_AGP2.py"""
    def __init__(self):
    ...
    def execute(self, parameters, messages):
        ...
        # the script tool has been imported as a module. Now call the main function
        GeMS_ProjectCrossSectionData_AGP2.main(parameter_values) 

class ProjectPointsToCrossSection(object):
    """\Scripts\GeMS_ProjectPtsToCrossSection_AGP2"""
    def __init__(self):
    ...
    def execute(self, parameters, messages):
        ...
        # the script tool has been imported as a module. Now call the main function
        GeMS_ProjectPtsToCrossSection_AGP2.main(parameter_values)         

class InclinationNumber(object):
    """\Scripts\GeMS_InclinationNumbers_AGP2.py"""
    def __init__(self):
    ...
    def execute(self, parameters, messages):
        ...
        # the script tool has been imported as a module. Now call the main function
        GeMS_InclinationNumbers_AGP2.main(parameter_values)  

class SetPlotAtScales(object):
    """\Scripts\GeMS_SetPlotAtScales_AGP2.py"""
    def __init__(self):
    ...
    def execute(self, parameters, messages):
        ...
        # the script tool has been imported as a module. Now call the main function
        GeMS_SetPlotAtScales_AGP2.main(parameter_values) 

class SetSymbols(object): 
    """\Scripts\GeMS_SetSymbols_AGP2.py"""
    def __init__(self):
    ...
    def execute(self, parameters, messages):
        ...
        # the script tool has been imported as a module. Now call the main function
        GeMS_SetSymbols_AGP2.main(parameter_values) 

class SetIDvalues(object): 
    """\Scripst\GeMS_reID_AGP2.py"""       
    def __init__(self):
    ...
    def execute(self, parameters, messages):
        ...
        # the script tool has been imported as a module. Now call the main function
        GeMS_reID_AGP2.main(parameter_values) 

class FGDC_1(object):
    """Scripts\GeMS_FGDC1_AGP2.py"""
    def __init__(self):
    ...
    def execute(self, parameters, messages):
        ...
        # the script tool has been imported as a module. Now call the main function
        GeMS_FGDC1_AGP2.main(parameter_values) 

class FGDC_2(object):
    """Scripts\GeMS_FGDC2_AGP2.py"""
    def __init__(self):
    ...
    def execute(self, parameters, messages):
        ...
        # the script tool has been imported as a module. Now call the main function
        GeMS_FGDC2_AGP2.main(parameter_values)

class FGDC_3(object):
    """Scripts\GeMS_FGDC3_AGP2.py"""   
    def __init__(self):
    ...
    def execute(self, parameters, messages):
        ...
        # the script tool has been imported as a module. Now call the main function
        GeMS_FGDC3_AGP2.main(parameter_values)
...
class PurgeMetadata(object):
    ...
    def execute(self, parameters, messages):
        ...
        # the script tool has been imported as a module. Now call the main function
        GeMS_PurgeMetadata_AGP2.main(parameter_values)
        
class RelationshipClasses(object):
    """Scripts\GeMS_RelationshipClasses1_AGP2.py"""
    ...
    def execute(self, parameters, messages):
        ...
        # the script tool has been imported as a module. Now call the main function
        GeMS_RelationshipClasses1_AGP2.main(parameter_values)
        
class FixStrings(object):
    """Scripts\GeMS_FixStrings_AGP2"""
    def __init__(self):
...
class TranslateToShape(object):
    """Scripts\GeMS_TranslateToShape_AGP2""" 
    def __init__(self):
    ...
    def execute(self, parameters, messages):
        ...
        # the script tool has been imported as a module. Now call the main function
        GeMS_TranslateToShape_AGP2.main(parameter_values) 
...
class TopologyCheck(object):
    """Scripts\GeMS_TopologyCheck_AGP2"""
    def __init__(self):
    ...
    def execute(self, parameters, messages):
        ...
        # the script tool has been imported as a module. Now call the main function
        GeMS_TopologyCheck_AGP2.main(parameter_values)
        
class GeologicNamesCheck(object):
    """Scripts\GeMS_GeolexCheck_AGP2"""
    def __init__(self):
    ...
    def execute(self, parameters, messages):
        ...
        # the script tool has been imported as a module. Now call the main function
        GeologicNamesCheck.main(parameter_values)
        
class ValidateDatabase(object):
    """Scripts\GeMS_ValidateDatabase_AGP2"""
    def __init__(self):
    ...
    def execute(self, parameters, messages):
        ...
        # the script tool has been imported as a module. Now call the main function
        ValidateDatabase.main(parameter_values)
        
class DMUtoDocx(object):
    """Scripts\GeMS_DMUtoDocx_AGP2"""
    def __init__(self):
